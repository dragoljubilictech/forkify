...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        _recipeViewDefault.default.renderSpiner();
...
const controlSearchResult = async function() {
    try {
        _resultViewDefault.default.renderSpiner();
        //Get search query
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        _addRecipeViewDefault.default.renderSpiner();
        //Uploud the new recipe data
        await _model.uploudRecipe(newRecipe);
        // Render recipe
        _recipeViewDefault.default.render(_model.state.recipe);
        // Success message
...
const init = function() {
    ...
    _addRecipeViewDefault.default.addHandlerUploud(controlAddRecipe);
};
init();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./model":"1pVJj","./views/recipeView":"82pEw","./views/searchView":"jcq1q","./views/resultView":"jeyjW","./views/paginationView":"2PAUD","./views/bookmarksView":"764v9","./views/addRecipeView":"Lo2AT","./config":"6V52N"}],"ciiiV":[function(require,module,exports) {
...
parcelHelpers.export(exports, "uploudRecipe", ()=>uploudRecipe
);
var _config = require("./config");
...
const uploudRecipe = async function(newRecipe) {
    try {
...
const KEY = '68d8115f-00ff-4d8c-a183-42e9aa1165c8';
...
class RecipeView extends _viewDefault.default {
    ...
    addHandlerAddBookmark(handler1) {
        this._parentElement.addEventListener('click', function(e) {
  ...
  <div class="recipe__directions">
    ...
    addHandlerRender(handler2) {
        [
            'hashchange',
            'load'
        ].forEach((ev)=>window.addEventListener(ev, handler2)
        );
    }
...
},{"./view":"aXC0x","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"aXC0x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jeyjW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"5jwFy","./view":"aXC0x","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./previewView":"i65ZK"}],"i65ZK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends _viewDefault.default {
    ...
    _generateMarkup() {
      ...
      `;
        // Page 1, and there an NO other pages
        return '';
    }
}
...
},{"./view":"aXC0x","./previewView":"i65ZK","url:../../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"Lo2AT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
